...
public class CashierTableController implements Initializable {

    @FXML
    private Label Employeeid;

    @FXML
    private AnchorPane CashierTableAPid;
...
//        });
    ...
    void BackOA(ActionEvent event) throws IOException {
        CashierTableAPid.getChildren().clear();
        CashierTableAPid.getChildren().add(FXMLLoader.load(getClass().getResource("/view/CashierHome.fxml")));
    }
