...
public class CashierOrderController implements Initializable {
    ...
    @FXML
    private AnchorPane CashierOrderForm;
...
//
//    @FXML
//    void cmbPaymentMethodOA(ActionEvent event) {
//
//   }
//
//    @FXML
...
//    }
    ...
    @FXML
    void CashierBackOA(ActionEvent event) throws IOException {

        CashierOrderForm.getChildren().clear();
        CashierOrderForm.getChildren().add(FXMLLoader.load(getClass().getResource("/view/CashierHome.fxml")));
    }
